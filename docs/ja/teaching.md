...
- **音響システム特論 / Advanced Topics of Acoustic Systems**（大学院）
    - 第1回 逆問題と統計的推定法 / Inverse Problem and Statistical Estimation 
    - 第2回 信号処理における最適化法 / Optimization in Signal Processing 
    - 第3回 スパースモデリング / Sparse Modeling 
    - 第4回 アレイ信号処理 / Array Signal Processing 
    - 第5回 波動場のモデリング / Wavefield Modeling 
    - 第6回 空間音響の基礎 / Basics of Spatial Audio 
    - 第8回 音場の分析と合成 / Sound Field Analysis and Synthesis 
